...
@section('sub-content-header', 'Add New Video')
		...
		<div class="row">
			<div class="col-xs-11">
				<div class="box box-info">
					...
					{{ Form::open(array('route' => 'video.store', 'files' => true, 'class' => 'form-horizontal', 'enctype' => 'multipart/form-data')) }}
						<div class="box-body">
							<div class="row">
								<div class="col-md-6">
								...
								<div class="col-md-6">
									...
									<div class="checkbox">
										{{ Form::label(null, null, array('class' => 'col-sm-3 control-label')) }}
										<label>
