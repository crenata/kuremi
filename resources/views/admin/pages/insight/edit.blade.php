...
@section('sub-content-header', 'Edit Insight')
		...
		<div class="row">
			<div class="col-xs-11">
				<div class="box box-info">
					...
					{{ Form::model($insight, array('route' => ['insight.update', $insight->id], 'method' => 'PUT', 'class' => 'form-horizontal')) }}
						<div class="box-body">
							...
							<div class="form-group">
								...
								<div class="col-sm-9">
									<img src="{{ $insight->image_anime_character }}" alt="">
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-9">
									{{ Form::file('image_anime_character', array('class' => 'form-control')) }}
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-9">
									{{ Form::select('peran_id', $perans, null, ['class' => 'form-control']) }}
								</div>
							</div>
							...
							<div class="form-group">
								{{ Form::label(null, null, array('class' => 'col-sm-2 control-label')) }}
								<div class="col-sm-9">
									<img src="{{ $insight->image_orang }}" alt="">
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-9">
									{{ Form::file('image_orang', array('class' => 'form-control')) }}
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-9">
									{{ Form::select('negara_id', $negaras, null, ['class' => 'form-control']) }}
								</div>
							</div>
						</div> <!-- .box-body -->
